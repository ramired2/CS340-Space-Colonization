    ...
    <div className='content centerDiv formContent'>
      <form id="target" action={link} encType="multipart/form-data" onSubmit={createEmpty}>
        ...
        <div className='formContainer'>
          <div className='centerIt'><input className='indivItem formItem' ref={parentRef} type="text" placeholder="Natural Resource Name" name="Ship Name" value={name} onChange={(e) => setName(e.target.value)}/></div>
          ...
          <div>Quantity (kgs)<input className='indivItem formItem' ref={parentRef} type="number" placeholder="Quantity" min = "0" value={natlQuantity} onChange={(e) => setnatlQuantity(e.target.value)}/></div>
        </div>
        <div className='buttonsInline'>
          ...
          <button className="btns indivItem formItem" type="submit"  /* onClick={/* handleAddPerson } */>Edit Natural Resource</button>
        </div>
      </form>
